      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="navbar">
            <div class="navbar-left-container">
              <h1><a class="logo" href="/" title="首页">小米商城</a></h1>
              <h1 style="margin-top:5px"><a @click="rootloginModalFlag=true"><img src="../assets/icon/管理员.svg"></a></h1>
            </div>
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                ...
                <div class="navbar-cart-container">
                  ...
                  <router-link to="Cart" tag="a" class="navbar-link navbar-cart-link">
        ...
        <!-- 管理员登陆模态框 -->
        <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':rootloginModalFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">管理员登录</div>
              <button class="md-close" @click="rootloginModalFlag=false">Close</button>
            </div>
            ...
            <div class="md-content">
              <div class="confirm-tips">
                ...
                <ul>
                  <li class="regi_form_input">
                    <i class="icon IconPeople"></i>
                    <input type="text" tabindex="1" name="rootName" v-model="rootName" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2"  name="rootPwd" v-model="rootPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" @keyup.enter="adminLogin">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
                <a href="javascript:;" class="btn-login" @click="adminLogin">登  录</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="md-overlay" v-if="rootloginModalFlag" @click="rootloginModalFlag=false"></div>
    </header>
</template>
    ...
    export default{
        data(){
            return{
              ...
              // 管理员登陆模态框
              rootloginModalFlag: false
            }
        },
        computed: mapState(['nickName','cartCount']),
        ...
        methods:{
            ...
            adminLogin() {
                if(!this.rootName || !this.rootPwd){
                  this.errorTip = true;
                  return;
                }
                else if(this.rootName === 'root' && this.rootPwd === '123456') {
