          ...
          <div class="filter stopPop" id="filter" :class="{'filterby-show':filterBy}">
            <dl class="filter-price">
              ...
              <dd v-for="(item,index) in priceFilter" :key="index">
                <a href="javascript:void(0)" @click="setPriceFilter(index)" :class="{'cur':priceChecked==index}">{{item.startPrice}}元 - {{item.endPrice}}元</a>
              </dd>
            </dl>
          </div>
            ...
            <div class="accessory-list col-4">
              <ul>
                <li v-for="(item, index) in goodsList" :key="index">
                  <div class="pic">
                    <a href="#"><img v-lazy="'http://localhost:3000/static/' + item.productImage" alt=""></a>
                  </div>
                  <div class="main">
